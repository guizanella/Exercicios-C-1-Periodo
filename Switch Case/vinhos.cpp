...
int main(){
	...
	switch(vinho){
		case 1:{
			printf("Vinho selecionado: Tinto"); printf("\n");
		...
		case 2:{
			printf("Vinho selecionado: Rose"); printf("\n");
		...
		case 3:{
			printf("Vinho selecionado: Branco"); printf("\n");
		...
		case 4:{
			printf("Vinho selecionado: Espumante"); printf("\n");
